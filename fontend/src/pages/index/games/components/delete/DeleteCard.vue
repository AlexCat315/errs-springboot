...
<template>
    <div class="card">
        <div class="header">
            ...
            <div class="actions">
                <button @click="deleteGameByID()" class="desactivate" type="button">彻底删除</button>
                <button @click="showGameListCard" class="cancel" type="button">取消</button>
            </div>
        </div>
    </div>
</template>
...
import { delete_game_by_id } from '../../../../../net/game/delete';
