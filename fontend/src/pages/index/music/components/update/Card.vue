...
<template>
    <div class="main">
        ...
        <div @click="playSong(song)" v-for="(song, index) in songs" :key="index" class="loader">
            <h3 style="margin-top: 34px;">{{ index + 1 }}</h3>
...
import { get_music_info_by_search, get_music_info_all } from "../../../../../net/music/get";
import Delete from "./Update.vue";
