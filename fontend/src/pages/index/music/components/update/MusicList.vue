...
import UpdatePanel from "./UpdatePanle.vue";
...
<template>
    <div>
        ...
        <div v-if="showDeletePanel" class="loading-overlay">
            <UpdatePanel style="transform:scale(0.8)" @delete:success="handleDeleteSuccess" @update:modelValue="handleUpdateModelValue"
                :song="showLikeSong" />
        </div>
