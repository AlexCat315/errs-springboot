...
<template>
  <form class="form">
    ...
    <div class="inputForm">
      ...
      <input v-model="loginForm.username" type="text" class="input" placeholder="邮箱账号"/>
    </div>
    ...
    <p class="p">还没有账户?<span class="span">立即注册</span></p>
    <p class="p line">或</p>
    ...
    <button @click="submitGoBackSetting()" class="button-submit-back">返回设置</button>
  </form>
