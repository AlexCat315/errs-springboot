...
<template>
  <div>
    ...
    <form class="form">
      <div class="card">
        <span class="card__title">Subscribe
          <svg fill="333" width="40px" viewBox="0 -960 960 960" height="40px" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div class="card__form">
          ...
          <button title="SignUp" class="sign-up">
            <svg fill="#e8eaed" width="24px" viewBox="0 -960 960 960" height="24px" xmlns="http://www.w3.org/2000/svg">
