...
<template>
  <div :style="{ background: globalTheme === 'light' ? '#fff' : '#333' }" class="card">
    ...
    <span :style="{color : globalTheme === 'light' ? 'black' : '#fff'}" class="card__title">Subscribe</span>
    <p :style="{color : globalTheme === 'light' ? 'black' : '#fff'}" class="card__content">Get fresh web design resources delivered straight to your inbox every week.</p>
