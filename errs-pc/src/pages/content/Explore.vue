...
<template>
  <div class="explore_content" @scroll="handleScroll"
    ...
    <!-- 轮播图 -->
    <div class="carousel" @mouseenter="showButtons = true" @mouseleave="showButtons = false">
      <div class="carousel-img" :class="{ fade: transitioning }">
        <img :src="images[currentIndex]" alt="Carousel Image">
      </div>
      <button v-if="showButtons" class="prev-button" @click="prevImage">
        <svg t="1737523739102" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="10941" width="22" height="22">
          <path
      ...
      <button v-if="showButtons" class="next-button" @click="nextImage">
        <svg t="1737523827842" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="12168" width="22" height="22">
          <path
