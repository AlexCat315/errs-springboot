...
import MovieIndex from "./explore/MovieIndex.vue";
...
const handleScroll = (event: Event) => {
    ...
    showTitle.value = scrollY.value > 100;
};
...
// 定时器
let autoSwitchTimer: number | undefined; // 修改为 number | undefined
...
<template>
    <div :style="{
    ...
    }" class="explore_content" @scroll="handleScroll">
        <!-- 顶部标题 -->
        <div :class="{ show: showTitle }" :style="{
        ...
        <!-- 轮播图 -->
        <div v-if="currentIndexDetil === null" class="carousel" @mouseenter="showButtons = true"
            @mouseleave="showButtons = false">
            <div :class="{ fade: transitioning }" class="carousel-img">
                <img :src="images[currentIndex]" alt="Carousel Image" />
            </div>
            <button v-if="showButtons" class="prev-button" @click="prevImage">
                <svg class="icon" height="22" p-id="10941" t="1737523739102" version="1.1" viewBox="0 0 1024 1024"
                    ...
                    <path
                        ...
                        fill="#FFF" p-id="10942"></path>
                </svg>
            </button>
            <button v-if="showButtons" class="next-button" @click="nextImage">
                <svg class="icon" height="22" p-id="12168" t="1737523827842" version="1.1" viewBox="0 0 1024 1024"
                    width="22" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div>
            ...
            <MovieIndex v-if="currentIndexDetil === null" />
            <!-- 书籍 -->
            <BookIndex />
