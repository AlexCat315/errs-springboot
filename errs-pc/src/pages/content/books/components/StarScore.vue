<style scoped>
  ...
  .rating {
    display: flex;
    flex-direction: row-reverse; /* 反转顺序，使1星在最左，5星在最右 */
  }
...
<template>
  <div class="rating">
    <input type="radio" id="star5" name="rate" value="5" @change="updateRating(5)" />
    ...
    <input value="4" name="rate" id="star4" type="radio" @change="updateRating(4)" />
    ...
    <input value="3" name="rate" id="star3" type="radio" @change="updateRating(3)" />
    ...
    <input value="2" name="rate" id="star2" type="radio" @change="updateRating(2)" />
    ...
    <input value="1" name="rate" id="star1" type="radio" @change="updateRating(1)" />
